<?php
/**
 * Installaion hooks for MP Stacks + WooGrid
 *
 ...
 * @since 1.0
 * @global $wpdb
 * @global $mp_stacks_woogrid_options
 * @global $wp_version
 * @return void
 */
function mp_stacks_woogrid_install() {
	global $wp_version, $mp_stacks_woogrid_activation;
	...
	wp_remote_post( 'http://tracking.mintplugins.com', array(
		...
		'body' => array( 
			'mp_track_event' => true, 
			'event_product_title' => 'MP Stacks + WooGrid', 
	...
	$mp_stacks_woogrid_activation = true;

}
register_activation_hook( MP_STACKS_WOOGRID_PLUGIN_FILE, 'mp_stacks_woogrid_install' );
 ...
 * @since 1.0
 * @global $wpdb
 * @global $mp_stacks_woogrid_activation
 * @return void
 */
function mp_stacks_woogrid_activation_shutdown(){
	
	global $mp_stacks_woogrid_activation;
	
	if ( $mp_stacks_woogrid_activation ){
		//Flush the rewrite rules
		flush_rewrite_rules();
	}
	
}
add_action( 'shutdown', 'mp_stacks_woogrid_activation_shutdown' );